...
public class QuanLyTestDrive {
    public static void main(String[] args) throws ParseException {
        ...
        HangHoa h1 = new HangThucPham("Gao nep","111",12000,720,"02/04/2020","02/04/2022");
        HangHoa h2 = new HangThucPham("Khoai lang","222",40000,845,"18/03/2020","18/03/2021");
        HangHoa h3 = new HangThucPham("Thit bo","333",180000,1030,"25/05/2020","25/09/2020");
        HangHoa h4 = new HangThucPham("Cai xanh","444",25000,690,"14/04/2020","14/06/2020");
        HangHoa h5 = new HangThucPham("Ca chua","555",17000,1100,"06/10/2020","06/02/2021");
        HangHoa h6 = new HangThucPham("Rau ma","666",26000,560,"23/05/2020","23/11/2020");
        HangHoa h7 = new HangThucPham("Mi Omachi","777",8000,3400,"16/06/2020","16/12/2022");
        //tạo đôi tượng hàng sành sứ
        HangHoa h8 = new HangSanhSu("Chen com","101",75000,530,"22/08/2018","Quang Nam");
        HangHoa h9 = new HangSanhSu("Dia com","202",40000,780,"07/03/2015","Nha Trang");
        HangHoa h10 = new HangSanhSu("Am tra","303",65000,1295,"19/11/2019","Khanh Hoa");
        HangHoa h11 = new HangSanhSu("Ly tra","404",35000,1330,"21/07/2017","Binh Đinh");
        HangHoa h12 = new HangSanhSu("Chen tra","505",100000,845,"15/10/2020","Phu Yen");
        HangHoa h13 = new HangSanhSu("Lo hoa","606",70000,990,"17/04/2019","Binh Thuan");
        HangHoa h14 = new HangSanhSu("Chau hoa","707",980000,205,"11/11/2021","Quang Ngai");
        //tạo đối tượng hàng điện máy
        HangHoa h15 = new HangDienMay("May quat","110", 170000,200,"04/07/2020",300);
        HangHoa h16 = new HangDienMay("May loc nuoc","220",900000,95,"12/11/2018",850);
        HangHoa h17 = new HangDienMay("May hut bui","330",780000,120,"08/08/2019",900);
        HangHoa h18 = new HangDienMay("May giat","440",940000,60,"15/10/2020",1200);
        HangHoa h19 = new HangDienMay("May lanh","550",690000,80,"24/06/2021",1100);
        HangHoa h20 = new HangDienMay("Tu mat","660",850000,45,"20/10/2018",500);
        HangHoa h21 = new HangDienMay("Tu đong","770",770000,350,"11/11/2021",800);
        ...
        System.out.println("|  MON HOC: LAP TRINH HUONG ĐOI TUONG   |");
		...
		do{
            ...
            System.out.println("| 5. Thong ke: (Tong so luong hang hoa, tong gia tri nhap kho, so luong tung loai hang).");
            ...
            switch(luaChon){
                ...
                case 4: //Menu sắp xếp hàng hóa giảm dần theo giá nhập, ngày nhập, theo loại và ngày nhập, theo loại và giá nhập.
                    ...
                    break;
                case 5: list.thongKeTongHangHoa();break;
